    ...
    return (
      <div>
        <h2 id="category-heading">
          <Translate contentKey="caseServiceApp.category.home.title">Categories</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="caseServiceApp.category.home.createLabel">Create new Category</Translate>
          </Link>
        </h2>
            ...
            <tbody>
              {categoryList.map((category, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{category.name}</td>
                  <td>
                    {category.parentCategory ? <Link to={`category/${category.parentCategory.id}`}>{category.parentCategory.id}</Link> : ''}
                  </td>
