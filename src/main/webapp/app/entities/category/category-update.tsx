    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="caseServiceApp.category.home.createOrEditLabel">
              <Translate contentKey="caseServiceApp.category.home.createOrEditLabel">Create or edit a Category</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : categoryEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="keyLabel" for="key">
                    <Translate contentKey="caseServiceApp.category.key">Key</Translate>
                  </Label>
                  <AvField id="category-key" type="text" name="key" />
                </AvGroup>
                <AvGroup>
                  <Label id="nameLabel" for="name">
                    <Translate contentKey="caseServiceApp.category.name">Name</Translate>
                  </Label>
                  <AvField id="category-name" type="text" name="name" />
                </AvGroup>
                <AvGroup>
                  <Label for="parentCategory.id">
                    <Translate contentKey="caseServiceApp.category.parentCategory">Parent Category</Translate>
                  </Label>
                  <AvInput id="category-parentCategory" type="select" className="form-control" name="parentCategory.id">
                    <option value="" key="0" />
                    {categories
