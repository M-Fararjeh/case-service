              ...
              <AvForm model={isNew ? {} : categoryEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label for="category.id">
                    <Translate contentKey="caseServiceApp.category.category">Category</Translate>
                  </Label>
                  <AvInput id="category-category" type="select" className="form-control" name="category.id">
                    <option value="" key="0" />
                    {categories
